...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col ">
      <div className="w-full px-8 py-6 flex items-center justify-start border-b border-neutral-800 gap-8">
        {/*Header*/}
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center gap-2">
            ...
            <div className="flex flex-row items-start gap-2">
              {" "}
              <div className="text-5xl font-semibold">Create new account</div>
              <span className="mt-8 w-2 h-2 bg-lime-400 rounded-full" />
            </div>
