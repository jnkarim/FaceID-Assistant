        ...
        <div className="w-full max-w-2xl flex flex-col items-center gap-3 sm:gap-4">
          ...
          <div className="w-full space-y-4 sm:space-y-5 mt-2 sm:mt-4">
            ...
            <button 
              onClick={() => login()}
              disabled={isLoading}
              className="w-full px-6 sm:px-8 py-3 sm:py-4 bg-white text-black rounded-xl hover:bg-neutral-100 active:bg-neutral-200 transition font-semibold text-base sm:text-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
